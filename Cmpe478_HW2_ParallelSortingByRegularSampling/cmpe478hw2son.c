...
Running: mpirun -np number_of_processors ./cmpe478hw2.o [size_of_array] [step_7_version]
number_of_processors: The number of processors of the algorithm running onto
size_of_array: Number of elements in the initial array to be sorted. Default value is 1000.
...
void createRandomArray(int *theList, int numberOfDummyElems, int maxRand,int mypid);
...
int main(int argc, char** argv)
{
	...
	if (mypid == 0)
	{
		...
		createRandomArray(theList, numberOfDummyElems, maxRand,mypid);
	}
	...
	switch (step7Version)
	{
		...
		case 3: //Step 7 Version 3
			...
			i = runVersion2_1(numprocs, mypid, sendCountList, receiveCountList);
			subList2 = (int *) malloc(i * sizeof(int));
			runVersion3_2(mypid, numprocs, subList, sendCountList, receiveCountList, receiveDisplacementList, subList2, fp);
