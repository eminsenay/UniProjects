...
<TABLE borderColor=#ffffff height=142 width="100%" bgColor=#ffffff border=0>
  ...
  <TR borderColor=#000000>
    ...
    <TD borderColor=#999999 width=62 bgColor=#cccccc>
      <DIV class=style11 align=center><STRONG>1.01&nbsp;  
      </STRONG><br /></DIV></TD>
    <TD borderColor=#999999 width=72 bgColor=#cccccc>
      <DIV class=style11 align=center><STRONG>2.01<br /></STRONG></DIV></TD>
    <TD borderColor=#999999 width=82 bgColor=#cccccc>
      <DIV class=style11 align=center><STRONG>3.01&nbsp;</STRONG> <br /></DIV></TD>
    <TD borderColor=#999999 width=111 bgColor=#cccccc>
      <DIV class=style11 align=center><STRONG>4.01<br /></STRONG></DIV></TD>
    <TD borderColor=#999999 width=94 bgColor=#cccccc>
      <DIV class=style11 align=center><STRONG><br />5.01<br /></STRONG></DIV><br /></TD>
      <TD borderColor=#999999 width=85 bgColor=#cccccc>
      <DIV class=style11 align=center><STRONG>6.01&nbsp;</DIV></TD>
...
%>  
	...
	<TR borderColor=#000000>
    	...
    	<TD align="right" nowrap borderColor=#e4e4e4 bgColor=#f5f5f5>
			<div align="right">
         		<INPUT name="<%=WAGER_101 %>" class="style9" size=5>
            	<span class="style18">,</span>
            	<input name="<%=WAGER_101_FLOAT %>" class="style9" size=1 maxlength="2" align=left>      
       		</div></TD>
       		
       	<TD align="right" nowrap borderColor=#e4e4e4 bgColor=#f5f5f5>
			<div align="right">
         		<INPUT name="<%=WAGER_201 %>" class="style9" size=5>
            	<span class="style18">,</span>
            	<input name="<%=WAGER_201_FLOAT %>" class="style9" size=1 maxlength="2" align=left>      
       		</div></TD>
       	<TD align="right" nowrap borderColor=#e4e4e4 bgColor=#f5f5f5>
			<div align="right">
         		<INPUT name="<%=WAGER_301 %>" class="style9" size=5>
            	<span class="style18">,</span>
            	<input name="<%=WAGER_301_FLOAT %>" class="style9" size=1 maxlength="2" align=left>      
       		</div></TD>
       		
       	<TD align="right" nowrap borderColor=#e4e4e4 bgColor=#f5f5f5>
			<div align="right">
         		<INPUT name="<%=WAGER_401 %>" class="style9" size=5>
            	<span class="style18">,</span>
            	<input name="<%=WAGER_401_FLOAT %>" class="style9" size=1 maxlength="2" align=left>      
       		</div></TD>
       	<TD align="right" nowrap borderColor=#e4e4e4 bgColor=#f5f5f5>
			<div align="right">
         		<INPUT name="<%=WAGER_501 %>" class="style9" size=5>
            	<span class="style18">,</span>
            	<input name="<%=WAGER_501_FLOAT %>" class="style9" size=1 maxlength="2" align=left>      
       		</div></TD>	
       	<TD align="right" nowrap borderColor=#e4e4e4 bgColor=#f5f5f5>
			<div align="right">
         		<INPUT name="<%=WAGER_601 %>" class="style9" size=5>
            	<span class="style18">,</span>
            	<input name="<%=WAGER_601_FLOAT %>" class="style9" size=1 maxlength="2" align=left>      
       		</div></TD>
    	<TD borderColor=#e4e4e4 bgColor=#f5f5f5>
