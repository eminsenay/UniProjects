...
<tr>
	<td>Eski Bütçe</td>
		...
		<tr>
			<td>kurumsal:</td>
			<td><input type="text" name="<%=INST_CODE%>" value="<%=instStr%>"/></td>
		<tr>
		<tr>
			<td>fonksiyonel:</td>
			<td><input type="text" name="<%=FUNC_CODE%>" value="<%=funcStr%>"/></td>
		<tr>
		<tr>
			<td>ekonomik:</td>
			<td><input type="text" name="<%=ECO_CODE%>" value="<%=ecoStr%>"/></td>
		<tr>
		<tr>
			<td>Bütçe tipi:</td>
			<td>
	...
	<td>Yeni Bütçe</td>
		...
		<tr>
			<td>kurumsal:</td>
			<td><input type="text" name="<%=INST_CODE1%>" value="<%=instStr%>"/></td>
		<tr>
		<tr>
			<td>fonksiyonel:</td>
			<td><input type="text" name="<%=FUNC_CODE1%>" value="<%=funcStr%>"/></td>
		<tr>
		<tr>
			<td>ekonomik:</td>
			<td><input type="text" name="<%=ECO_CODE1%>" value="<%=ecoStr%>"/></td>
		<tr>
		<tr>
			<td>Bütçe tipi:</td>
			<td>
				<select name="<%=BUDGET_TYPE1 %>">
				<option value="<%=BudgetTO.STD %>">Standart</option>
				<option value="<%=BudgetTO.WAGER %>">Maaş</option>
				</select>
			</td>
