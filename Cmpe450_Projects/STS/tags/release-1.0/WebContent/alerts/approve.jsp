...
<title>Bogazici Universitesi Satin Alma Sistemi</title>
...
<form action="../Pages/onayBekleyenler/onaybekleyenler.jsp" method="post">
            <table bgcolor="#FFFFFF" width="300" border="0" cellspacing="0" cellpadding="0" class="tablefont">
              ...
              <tr>
                ...
                <td><font size="6" font = "verdana "color="Indigo"><i><img src="../images/spacer.gif" width="40">
                 <center>&nbsp;&nbsp; Fiş Onaylandı.   </center>
                </i> </font></td>
              ...
              <tr> 
                ...
                <td> <font size="5" font = "verdana "color="Indigo"> 
                  <center>
                    <p>&nbsp;</p><p><input type="submit" name="Submit" value="  Ana Menüye Dön  ">
                  </p></center>
                  </font> </td>
              </tr>
            </table>
