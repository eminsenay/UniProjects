 ...
 %>
		...
		<table width="100%" border="0">
			<tr>
				...
				<p align="center"><font color="white"><b>DEPO HARCAMA SONUCU</b></font></p>
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td colspan="2" class="generalFormCell"><strong><span class="style3">Lütfen
						miktar kısmına rakam girip tekrar deneyiniz!<strong></span></td>
					</tr>
					<tr>
						<td colspan="2" class="generalFormCell">
					...
					<tr>
						<td width="50%" class="generalFormCell">Harcamak istediğiniz miktar :</td>
					...
					<tr>
						<td width="50%" class="generalFormCell">Şu an depoda olan miktar :</td>
						<td width="50%" class="generalFormCell"><strong><%=currentAmount + miktar%><strong></td>
					</tr>
					<tr>
					...
					%>
					<tr>
						<td colspan="2" class="generalFormCell"><strong><%=urunIsmi%><%=uyari3%><strong></td>
					</tr>
					...
					<%
								...
								sp.depoCikisGDC(urunID, miktar, rafNumarasi,
								aciklama);
					...
					<tr colspan="2">
						<td class="generalFormCell"><strong><%=uyari2%><strong></td>
					</tr>
