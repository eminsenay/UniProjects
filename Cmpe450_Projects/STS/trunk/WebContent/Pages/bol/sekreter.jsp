...
<!-- Bu sayfada onayln bir fi?, ilgili Bolum Baskanina gönderilmektedir, -->
...
<form name="onayFormu" action="sekreter.jsp" method="post">
 ...
 <table align="center" bgcolor="#FFFFFF" width="420" border="2" bordercolor="#CCCCFF" cellspacing="0" cellpadding="0" align=left class="tablefont3">
                               ...
                               if(Double.parseDouble(toplamTutar)<=Double.parseDouble(MevcutTutar) )
                               {
                            	 /*  String kurumsalKod = rs.getString("KurumsalKod");
                            	   ...
                            	   BudgetBusinessObj budgetBO = new BudgetBusinessObj();
                          			...
                          			mevcutTutar = "" + currentBudget.getNetBudget();*/
                  				 %>
               						<tr>
                   					    <td>
                                 <%
               ...
               <tr>
                   <td colspan="4" align="center">
                       <label><font color="red">Sistemde Seçili Kalem ile ilgili Fonksiyonel ve Ekonomik Kodlar bulunmamaktadır!</font></label>
                       </td>
       </tr>
		       <%
		       }//end if
...
<div id="footer2">	  
    <p align="center"><b><font size="-2" face="Verd, Arial, Helvetica, sans-serif" color:black>Bilgisayar 
