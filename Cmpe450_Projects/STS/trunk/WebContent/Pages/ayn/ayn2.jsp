...
<div id="topright2"><SCRIPT language="JavaScript">
...
<table width="688" border="0">
	<tr>
		<td width="331"><br>
		T.C. <br>
		Bo&#287;azi&ccedil;i &Uuml;niversitesi <br>
		<span id='security<%=securityIndex++ %>'><%=butceTipiStr%></span></td>
		<td width="341">
		<p align="right">No: <span id='security<%=securityIndex++ %>'><%=muayeneRaporuNo%></span>
		</p>
		<p align="right">Tarih: <span id='security<%=securityIndex++ %>'><%=duzenlenmeTarihi%></span>
		</p>
		</td>
	</tr>
</table>
...
<p align="left">
<p align="left">&#304;li&#351;ik <span
	id='security<%=securityIndex++ %>'><%=faturaNo%></span>
say&#305;l&#305; <span id='security<%=securityIndex++ %>'><%=fisToplami%></span>
liral&#305;k 1 adet faturada cins ve miktar&#305; yaz&#305;l&#305; <span
	id='security<%=securityIndex++ %>'><%=kalemSayisi%></span> e&#351;ya
matluba muvaf&#305;kt&#305;r.
...
<table width="750" border="1" cols="6">
	...
	<tr>
		...
		<td><label><%=Long.parseLong(mallar[i].birimFiyat)
							* Long.parseLong(mallar[i].miktar)%></label></td>
	</tr>
	<%
	}
	%>
...
<table width="100%" border="0">
	<tr>
		<!-- KURULDAKİ GÖREVİ -->
		<td>
		<div align="center"><u>BA&#350;KAN</u></div>
		</td>
		<td>
		<div align="center"><u>ÜYE</u></div>
		</td>
		<td>
		<div align="center"><u>ÜYE</u></div>
		</td>
	...
	<tr>
		...
		%>
		<td>
		<div align="center">Ayniyat Sayman&#305;</div>
		</td>
		<td>
		<div align="center">Ayniyat Üyesi</div>
		</td>
		<td>
		<div align="center">Proje Yürütücüsü
		<p><i><%=requestedBy%></i>
		<p>adına
		<p>
		</div>
	...
	<tr>
		<!-- İSMİ -->
		<td>
		<div align="center"><i><%=uyeIsimleri[0]%></i></div>
		</td>
		<td>
		<div align="center"><i><%=uyeIsimleri[1]%></i></div>
		</td>
		<td>
		<div align="center"><i><%=uyeIsimleri[2]%></i></div>
		</td>
		<%
		if (dortKisi) {
		%>
		<td>
		<div align="center"><i><%=uyeIsimleri[3]%></i></div>
		</td>
		<%
		}
		%>
...
<table width="100%" border="0">
	<tr>
		<td>
		<div align="center"><input name="OnaylaButon" type="button"
			onClick="preOnayDugmesi()" value="Onayla"></div>
		</td>
		<td>
		<div align="center"><input name="ReddetButon" type="button"
			onClick="preRedDugmesi()" value="Reddet"></div>
		</td>
	</tr>
</table>
<%
...
<table width="100%" border="0">
	<tr>
		<td>
		<div align="center"><input name="SifirlaButton" type="button"
			onClick="sifirlaDugmesi()" value="Raporu Yeniden İmzaya Aç">
		</div>
		</td>
	</tr>
</table>
...
%> <!-- hidden fieldlar --> <!-- SECURITY ICIN HIDDEN FIELDLAR BEGIN -->
<input type="hidden" name='security_onayRed' value='';> <input
	type="hidden" id='security_field_no' value="<%=securityIndex-1%>">
<input type="hidden" name="imza" value=""> <input type="hidden"
	name="document_content" value=""> <input id="security1"
	type="hidden" name="securityDate"
	value="<%=System.currentTimeMillis()%>"> <!-- SECURITY ICIN HIDDEN FIELDLAR END -->
<input type="hidden" name="onay" value=""> <!-- hidden fieldlar -->
