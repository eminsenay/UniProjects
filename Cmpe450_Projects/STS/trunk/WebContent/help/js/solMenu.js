...
d.config.target = '_self';
	...
	d.add(depo, 0,'Depo');
	d.add(depo+1, depo,'Rektör', 'STS_Rektor_sayfasi.html');	
	d.add(depo+2, depo,'Dekan', 'STS_Dekan_sayfasi.html');	
	d.add(depo+3, depo,'Bölüm Baþkaný', 'STS_Bolum_Baskani_sayfasi.html');
	d.add(depo+4, depo,'Genel Depo Sorumlusu');
	d.add(depo+5, depo+4,'Alt Limit Belirleme', 'STS_alt_limit_belirleme.html');
	d.add(depo+6, depo+4,'Alt Limit Uyarý', 'STS_alt_limit_uyari.html');
	d.add(depo+7, depo+4,'Depo Sorgulama', 'STS_depo_sorgulama.html');
	d.add(depo+8, depo+4,'Ürün Çýkýþý', 'STS_urun_cikisi.html');
	d.add(depo+9, depo+4,'Ürün Giriþi', 'STS_urun_girisi.html');
	d.add(depo+10, depo+4,'Ürün Gönderimi', 'STS_urun_gonderim.html');
	d.add(depo+11, depo,'Bölüm Depo Yöneticisi', 'STS_bolum_depo_yoneticisi.html');
