...
public class StockApproval {
	/**@
	 * Tum pending durumunda olan �r�nlerin resultset�n� donderiyor
	 * datalar� BEKLEYEN_URUNLER  tablosundan al�yor
	...
	/**@
	 * Onay durumunda(�r�n�n�n gelmesi ve onay)
...
return false;
	...
	public final boolean depoGirisDDC(
		...
		try {
			...
			new Object [] {grupNo, urunNo, amount, aciklama});
			db.commitTransaction();
			db.closeConnection();
			return true;
		} catch (Exception e) {
