...
public interface ExpenseDAO {	
	...
	throws NoSuchBudgetException, SQLException, ExpenseAlreadyDeleted;
	...
	void addStdExpense(final BudgetTO budget,
			...
			StdExpenseAlreadyDefined, NotEnoughBudget, Exception;
	 ...
	 */
	void updateStdExpenditure(final BudgetTO budget,
